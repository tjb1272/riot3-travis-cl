...
function cloneRepo() {
    ...
    cmd.get(
        'rm -rf riot2-automation && git clone https://github.com/tjb1272/riot2-automation.git',
...
function transferProjectToRemote(failed, successful) {
    return ssh.putDirectory(__dirname + '/riot2-automation', '/home/ubuntu/riot2-automation-temp', {
        recursive: true,
        concurrency: 1,
...
function createRemoteTempFolder() {
    return ssh.execCommand('rm -rf riot2-automation-temp && mkdir riot2-automation-temp', { cwd: '/home/ubuntu' })
}
...
function updateRemoteApp() {
    return ssh.execCommand('cp -r riot2-automation-temp/* riot2-automation/ && rm -rf riot2-automation-temp/*', { cwd: '/home/ubuntu' })
}
...
function sshConnect() {
    ...
    ssh.connect({
        ...
        .then(function() {
            ...
            console.log("Creating `riot2-automation-temp` folder.");
